...
namespace Thoth_Astrological_Calculator.Types
{
    internal interface IPractitioner
    {
        ...
        string? LocationOfBirth { get; }

        /// <summary> The time zone as of the user's birth date and location. Must be accurate as per the practitioner's nativity date, as the modern daylight configuration will differ! </summary>
        TimeZoneInfo? NativityTimeZone { get; }
