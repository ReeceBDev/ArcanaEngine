...
namespace Thoth.Types.Practitioner
{
    ...
    internal interface ICelestialCorrespondences
    {
        ...
        /// <summary> The practitioner's twelve natal houses and their zodiacal correspondences, calculated via the fixed whole-sign house system.
        /// Null until both the birth time and birth location have been set. </summary>
        ImmutableArray<IZodiacalHouse>? Houses { get; }
